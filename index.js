...
function ShowPost(){
    ...
    if (Titlearray.length >0 ){
        ...
        {
            PostCard+= ("<div class='card  border-success mb-3 col-md-3 col-lg-4' style='margin : 1%'><div class='card-header bg-transparent border-success'><h2><span>"+ Titlearray[i]+ "</span></h2></div><div class='card-body text-success'><p class='card-text'>"+Descriptionarray[i]+"</p></div></div>");
